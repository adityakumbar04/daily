...
const QUESTIONS = [
  ...
  { q: "Maine saara din ladaai jhagda aur gaali gloch aur jhut se ijtinaab kiya?", options: ["Yes", "No"], audio: "audio/5th.mp3" },
  ...
  { q: "Maine Isha ki namaz jamat ke saath adaa ki aur taravee bhi padi?", options: ["Yes", "No"], audio: "audio/12.mp3" },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('confirmBtn').addEventListener('click', async () => {
    ...
    try {
      ...
      // If you run the frontend on a static dev server (e.g. :5500),
      // POST /api/* will hit that server and may return 405.
      ...
      const API_URL = `${API_BASE}/api/responses`;
